...
import com.codely.demo.cat.InvalidToy
...
fun main() {
    ...
    try {
        ...
        when (e) {
            ...
            is InvalidToy -> println("Upss looks like the toy was invalid, please remember that blanks or empty toys are not valid\"")
